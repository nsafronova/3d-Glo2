(() => {
   ...
   const e = ({
      ...
      r.addEventListener("input", (e => {
         ...
         e.target.value.match(/[а-я -]+/gi) || "" !== e.target.value ? e.target.classList.add("success") : e.target.classList.add("error")
      })), n.forEach((e => {
         ...
         o.addEventListener("submit", (e => {
            e.preventDefault(), (() => {
               ...
               a.textContent = "Загрузка..", o.append(a), r.forEach(((e, t) => {
                  ...
                  e.forEach((e => {
                     e.value = "", a.style.color = "white", a.textContent = "Спасибо! Наш менеджер свяжется с Вами!"
                  }))
               })).catch((e => {
      ...
      t.addEventListener("input", (t => {
         t.target !== o && t.target !== a && t.target !== r && t.target !== c || (() => {
            ...
            let l = 0,
               i = 1,
               d = 1;
            r.value > 1 && (i += r.value / 10), c.value && c.value < 5 ? d = 2 : c.value && c.value < 10 && (d = 1.5), o.value && a.value ? (l = e * t * s * i * d, n.textContent = l) : l = 0, n.textContent = Math.ceil(l)
         })()
      }))
   })(100), e({
      formId: "form1",
